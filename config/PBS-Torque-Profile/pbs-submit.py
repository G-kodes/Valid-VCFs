...
parser.add_argument(
    "-j", help="Merge standard error and standard out. (oe or eo)")
...
parser.add_argument(
    "-V", help="Export all environment variables.", action="store_true")
...
if "resources" in job_properties:
    ...
    if "cpus" in resources:
        ppn = "ppn=" + str(resources["cpus"])
    if "queue" in resources:
        q = " -q " + str(resources["queue"])
...
cmd = "qsub {a}{A}{b}{c}{C}{d}{D}{e}{f}{h}{j}{l}{m}{M}{N}{o}{p}{P}{q}{t}{u}{v}{V}{w}{W}{rp}{dep}{ex}".format(modules=module_loads,
